...
const STEPS: Step[] = [
  ...
  { id: 2, label: "Employee Data",     description: "Validate salary & TDS entries for all 12 employees" },
  ...
  { id: 7, label: "E-File",            description: "Submit Form 24Q to ITD e-filing portal" },
  { id: 8, label: "Receipt",           description: "Download provisional receipt & acknowledgement" },
];

const MOCK_DELAYS = [900, 1200, 1000, 1400, 0, 1800, 1200, 600];
...
export function FilingWizard24Q({
  open,
  onOpenChange,
  tan,
  period,
  onComplete,
}: FilingWizard24QProps) {
        ...
        <DialogContent className="sm:max-w-3xl p-8" showCloseButton={false}>
          ...
          <div className="pt-2">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <p className="text-base font-semibold">
                  {done
                    ? "Form 24Q filed successfully!"
                    : filing && activeStep
                    ? activeStep.label
                    : "Submit Form 24Q — Salary TDS Return"}
                </p>
              </div>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground pl-7">
              {done
                ? "Form 24Q submitted. Provisional receipt is available."
                : filing && activeStep
      ...
      <EVCOTPModal
        ...
        description={
          <>
            ...
            TRACES portal. Enter it to authorise Form 24Q filing.
          </>
        }
